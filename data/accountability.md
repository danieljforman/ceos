...
| # | Role |
|---|------|
| 1 | Run the business — day-to-day execution of the plan |
| 2 | P&L management — budget, profitability, financial health |
| 3 | Remove barriers — unblock the leadership team |
| 4 | Accountability — hold team members to their commitments |
| 5 | Special projects — integrate cross-functional initiatives |
...
*Add or remove seats as needed. The key rule: every function of the business has one clear owner.*
